...
#=======================================================================================================================
def train(net, trainLoader, criterion1, criterion2, optimizer, epoch, args, logs):
...
def test(net, testLoader, criterion1, criterion2, epoch, args, logs):
    ...
    logits = torch.empty([12, samples, len(logs.keys)])
    ...
    logits = criterion1.activate(logits)
...
if __name__=='__main__':
    ...
    args.save = os.path.join(datapath, 'Others/Ensemble/MLSoftmax')
    ...
    criterion1 = Loss.MultiExpertLoss(cls_num_list, N, prior)
    criterion2 = Loss.MultiExpertMLSoftmax()
    ...
    for epoch in range(args.num_epochs):
        ...
        train(net, trainLoader, criterion1, criterion2, optimizer, epoch, args, logs)
        test(net, testLoader, criterion1, criterion2, epoch, args, logs)
