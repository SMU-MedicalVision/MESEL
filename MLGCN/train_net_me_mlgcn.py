...
if __name__=='__main__':
    ...
    args.save = os.path.join(datapath, 'Others/Ensemble/MLGCN')
    ...
    state_dict = torch.load('/home/laijiewei/Hierarchic/data/Sigmoid/0-0/model.pth', map_location='cpu')
    embedding = state_dict['fc.weight']
    ...
    net = MLGCN.MENet(num_classes=len(keys), adj_matrix=prior - np.eye(len(keys)), t=0.3, inp=embedding).cuda()
