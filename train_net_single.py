...
if __name__=='__main__':
    ...
    parser.add_argument('--acti', type=str, default='Sigmoid')
    parser.add_argument('--k1', type=float, default=0)
    parser.add_argument('--k2', type=float, default=0)
    parser.add_argument('--symbiotic', type=float, default=0)
    parser.add_argument('--suppress', type=float, default=17)
    ...
    if args.symbiotic:
        args.save = os.path.join(datapath, 'Symbiotic{}/{}-{}-{}'.format(args.acti, args.symbiotic, args.k1, args.k2))
    elif args.acti is 'ConcurrentSoftmax':
        args.save = os.path.join(datapath, '{}/{}-{}-{}'.format(args.acti, args.suppress, args.k1, args.k2))
    else:
        args.save = os.path.join(datapath, '{}/{}-{}'.format(args.acti, args.k1, args.k2))
   ...
   for key in list(set2 & set3):
    ...
    criterion = Loss.BCELoss(cls_num_list, N, args.acti, prior, args.k1, args.k2, args.symbiotic, args.suppress)
